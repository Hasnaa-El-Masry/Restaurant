...
const SectionHeader = ({ subtitle, title, description, className, page }) => {
  return (
...
export const SectionHeaderContent = ({
  ...
  return (
    <div className={`${classes.container} ${className ? className : ""}`}>
      <MotionWrapper classes={classes.subtitle} delay={0.1}>
        {subtitle}
      </MotionWrapper>

      <MotionWrapper classes={classes.pattern_img} delay={0.1}>
        <img src={pattern_img} alt="" />
      </MotionWrapper>
      ...
      {description && (
        <MotionWrapper isActive classes={classes.description} delay={1.5}>
