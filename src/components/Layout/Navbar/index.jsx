...
const Navbar = ({ toggleHandler }) => {
  ...
  return (
    <nav
      className={`${classes.nav} ${isScrolled ? classes.hide_nav_top : ""} ${
        scroll.scrollY > 900 && scroll.direction == "down"
          ? classes.hide
          : classes.show
      }`}
    >
          ...
          <ul>
            <li>
              <Link to="">
                ...
                <span className={classes.call}>+1 123 456 7890</span>
              </Link>
            </li>
            <li className="primary-color">
              <TbSquareRotated />
      ...
      <div
        className={`${classes.nav__bottom} ${
          isScrolled ? classes.scroll_bg : ""
        }`}
      >
        <Container>
