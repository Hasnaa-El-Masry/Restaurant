        ...
        <div className={classes.content}>
          ...
          <div className={classes.address_info}>
            ...
            <div className={classes.location}>
              ...
              <p>
                <Link to="">booking@domainname.com</Link>
              </p>
              <p>
                <Link to="">Booking Request : +88-123-123456</Link>
              </p>
            ...
            <div className={classes.action}>
              <IconInput
                icon={({ className }) => (
                  <MdOutlineEmail className={className} />
                )}
                input={({ className }) => (
                  <input
                    className={className}
              ...
              />
              <Button style={classes.btn} variant="primary">
                subscribe
              </Button>
            </div>
          </div>
